...
{fa:"ببخشید", en:"excuse me / sorry", translit:"bebakhshid", emoji:"🙇", audio:"", image:""},
...
{fa:"سخت", en:"difficult", translit:"sakht", emoji:"💪", audio:"audio/sakht.mp3", image:"images/sakht.png"},
  /* ── Travel pack ── */
  {fa:"مامان", en:"mom", translit:"mâmân", emoji:"🤱", audio:"", image:""},
  {fa:"بابا", en:"dad", translit:"bâbâ", emoji:"👨", audio:"", image:""},
  {fa:"مامان بزرگ", en:"grandma", translit:"mâmân bozorg", emoji:"👵", audio:"", image:""},
  {fa:"بابا بزرگ", en:"grandpa", translit:"bâbâ bozorg", emoji:"👴", audio:"", image:""},
  {fa:"خواهر", en:"sister", translit:"khâhar", emoji:"👧", audio:"", image:""},
  {fa:"برادر", en:"brother", translit:"barâdar", emoji:"👦", audio:"", image:""},
  {fa:"عمه", en:"aunt (dad's side)", translit:"amme", emoji:"👩", audio:"", image:""},
  {fa:"عمو", en:"uncle (dad's side)", translit:"amu", emoji:"👨", audio:"", image:""},
  ...
  {fa:"هواپیما", en:"airplane", translit:"havâpeymâ", emoji:"✈️", audio:"", image:""},
  ...
  {fa:"هتل", en:"hotel", translit:"hotel", emoji:"🏨", audio:"", image:""},
  {fa:"تاکسی", en:"taxi", translit:"tâksi", emoji:"🚕", audio:"", image:""},
