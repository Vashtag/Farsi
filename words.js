...
{fa:"می‌خواهم بخوابم", en:"I want to sleep", translit:"mikham bekhâbam", emoji:"😴", audio:"audio/mikham_bekhabam.mp3", image:""},
{fa:"ببخشید", en:"excuse me / sorry", translit:"bebakhshid", emoji:"🙇", audio:"", image:"images/bebakhshid.png"},
{fa:"دوست ندارم", en:"I don’t like", translit:"dust nadâram", emoji:"🚫❤️", audio:"audio/dust_nadaram.mp3", image:""},
{fa:"عالی", en:"great", translit:"âli", emoji:"🌟", audio:"audio/ali.mp3", image:""},
{fa:"خوب", en:"good", translit:"khub", emoji:"👍", audio:"audio/khub.mp3", image:""},
{fa:"بد", en:"bad", translit:"bad", emoji:"👎", audio:"audio/bad.mp3", image:""},
{fa:"سریع", en:"fast", translit:"sari'", emoji:"⚡", audio:"audio/sari.mp3", image:""},
{fa:"آهسته", en:"slow", translit:"âheste", emoji:"🐢", audio:"audio/aheste.mp3", image:""},
{fa:"آسان", en:"easy", translit:"âsân", emoji:"👌", audio:"audio/asan.mp3", image:""},
{fa:"سخت", en:"difficult", translit:"sakht", emoji:"💪", audio:"audio/sakht.mp3", image:""},
  /* ── Travel pack ── */
  ...
  {fa:"خواهر", en:"sister", translit:"khâhar", emoji:"👧", audio:"", image:"images/khahar.png"},
  {fa:"برادر", en:"brother", translit:"barâdar", emoji:"👦", audio:"", image:"images/baradar.png"},
  ...
  {fa:"خاله", en:"aunt (mom's side)", translit:"khâle", emoji:"👩", audio:"", image:"images/khale.png"},
  {fa:"دایی", en:"uncle (mom's side)", translit:"dâyi", emoji:"👨", audio:"", image:"images/dayi.png"},
  {fa:"خانواده", en:"family", translit:"khânevâde", emoji:"👨‍👩‍👧‍👦", audio:"", image:"images/khanevade.png"},
  {fa:"هواپیما", en:"airplane", translit:"havâpeymâ", emoji:"✈️", audio:"", image:"images/havapeyma.png"},
  {fa:"فرودگاه", en:"airport", translit:"forudgâh", emoji:"🛫", audio:"", image:"images/forudgah.png"},
  {fa:"چمدان", en:"suitcase", translit:"chamedân", emoji:"🧳", audio:"", image:"images/chamedan.png"},
  {fa:"پاسپورت", en:"passport", translit:"pâsport", emoji:"🛂", audio:"", image:"images/pasport.png"},
  ...
  {fa:"اتوبوس", en:"bus", translit:"otobus", emoji:"🚌", audio:"", image:"images/otobus.png"},
  {fa:"قطار", en:"train", translit:"qatâr", emoji:"🚂", audio:"", image:"images/qatar.png"},
  {fa:"بلیط", en:"ticket", translit:"belit", emoji:"🎫", audio:"", image:"images/belit.png"},
  {fa:"دوستت دارم", en:"I love you", translit:"dustat dâram", emoji:"❤️", audio:"", image:"images/dustat_daram.png"},
  ...
  {fa:"دستشویی", en:"bathroom", translit:"dastshui", emoji:"🚽", audio:"", image:"images/dastshui.png"},
  ...
  {fa:"اسب", en:"horse", translit:"asb", emoji:"🐴", audio:"", image:"images/asb.png"},
  {fa:"گوسفند", en:"sheep", translit:"gusfand", emoji:"🐑", audio:"", image:"images/gusfand.png"},
  {fa:"بز", en:"goat", translit:"boz", emoji:"🐐", audio:"", image:"images/boz.png"},
  {fa:"موش", en:"mouse", translit:"mush", emoji:"🐭", audio:"", image:"images/mush.png"},
  {fa:"ببر", en:"tiger", translit:"babr", emoji:"🐯", audio:"", image:"images/babr.png"},
  {fa:"فیل", en:"elephant", translit:"fil", emoji:"🐘", audio:"", image:"images/fil.png"},
  {fa:"میمون", en:"monkey", translit:"meymun", emoji:"🐒", audio:"", image:"images/meymoon.png"},
  {fa:"خرس", en:"bear", translit:"khers", emoji:"🐻", audio:"", image:"images/khers.png"},
